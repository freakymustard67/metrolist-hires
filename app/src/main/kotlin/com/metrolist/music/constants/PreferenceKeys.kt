...
// slskd high-res source (disabled by default; YouTube Music stays the default source)
val SlskdEnabledKey = booleanPreferencesKey("slskdEnabled")
val SlskdBaseUrlKey = stringPreferencesKey("slskdBaseUrl")
val SlskdApiKeyKey = stringPreferencesKey("slskdApiKey")
...
// JSON blob: recommendations built from listening history, with a refresh timestamp
val RecommendationsCacheKey = stringPreferencesKey("recommendations_cache")
